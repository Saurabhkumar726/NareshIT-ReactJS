          ...
          <div className="container py-md-4">
            <div className="row footer-top-29">
              <div className="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-1 pr-lg-5">
                ...
                <p>
                  Address : Study course, 2nd Floor, Durga Bhavani Plaza, Ameerpet, Hyderabad
                </p>
                <p className="my-2">
                  Phone : <a href="tel:+1(21) 234 4567">+91-8179191999</a>
                </p>
                <p>
                  Email : <a href="mailto:info@example.com">onlinetraining@nareshit.com</a>
                </p>
        ...
        <section className="w3l-copyright text-center">
          <div className="container">
            <p className="copy-footer-29">
              © 2025 Study Course. All rights reserved. Design by Saurabh
              <a rel="noreferrer" href="https://nareshit.com/" target="_blank">
                NareshIT
              </a>
            </p>
          </div>
